...
class CertificateRevocationList(metaclass=abc.ABCMeta):
    ...
    def __len__(self) -> int:
        """
        Number of revoked traefik-public-certificates in the CRL.
        """
    ...
    def __getitem__(
        ...
        """
        Returns a revoked certificate (or slice of revoked traefik-public-certificates).
        """

    @abc.abstractmethod
    def __iter__(self) -> typing.Iterator[RevokedCertificate]:
        """
        Iterator over the revoked traefik-public-certificates
        """
