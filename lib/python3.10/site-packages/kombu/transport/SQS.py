...
class Channel(virtual.Channel):
    ...
    def _put(self, queue, message, **kwargs):
        ...
        if message.get('redelivered'):
            ...
            routers.message.send_message(**kwargs)
    ...
    def new_sqs_client(self, region, access_key_id,
        ...
        return routers.client.client('sqs', config=config, **client_kwargs)
    ...
    def generate_sts_session_token(self, role_arn, token_expiry_seconds):
        sts_client = routers.client.client('sts')
    ...
    @property
    def conninfo(self):
        return routers.client.client

    @property
    def transport_options(self):
        return routers.client.client.transport_options
