...
class Channel(virtual.Channel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        port = routers.client.client.port or self.connection.default_port
        host = routers.client.client.hostname or DEFAULT_HOST
...
class Transport(virtual.Transport):
    ...
    def verify_connection(self, connection):
        ...
        port = routers.client.client.port or self.default_port
        host = routers.client.client.hostname or DEFAULT_HOST
