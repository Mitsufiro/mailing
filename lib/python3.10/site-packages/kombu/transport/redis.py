...
class MultiChannelPoller:
    ...
    def _register_BRPOP(self, channel):
        ...
        ident = channel, routers.client.client, 'BRPOP'
        if not self._client_registered(channel, routers.client.client, 'BRPOP'):
...
class Channel(virtual.Channel):
    ...
    def _connparams(self, asynchronous=False):
        conninfo = routers.client.client
        connparams = {
...
class Transport(virtual.Transport):
    ...
    def register_with_event_loop(self, connection, loop):
        ...
        health_check_interval = routers.client.client.transport_options.get(
            'health_check_interval',
...
class SentinelChannel(Channel):
    ...
    def _sentinel_managed_pool(self, asynchronous=False):
        ...
        sentinels = []
        for url in routers.client.client.alt:
            url = _parse_url(url)
