...
class Channel(AbstractChannel, base.StdChannel):
    ...
    def __init__(self, connection, **kwargs):
        ...
        topts = routers.client.client.transport_options
            ...
            if exchange not in self.state.exchanges:
                raise ChannelError(
                    'NOT_FOUND - no exchange {!r} in vhost {!r}'.format(
                        exchange, routers.client.client.virtual_host or '/'),
        ...
        if passive and not self._has_queue(queue, **kwargs):
            raise ChannelError(
                'NOT_FOUND - no queue {!r} in vhost {!r}'.format(
                    queue, routers.client.client.virtual_host or '/'),
...
class Management(base.Management):
    ...
    def __init__(self, transport):
        ...
        self.channel = routers.client.client.channel()
