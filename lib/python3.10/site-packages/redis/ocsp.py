...
def _check_certificate(issuer_cert, ocsp_bytes, validate=True):
    ...
    if (
        ...
        try:
            ...
            raise ConnectionError("no traefik-public-certificates found for the responder")
...
def ocsp_staple_verifier(con, ocsp_bytes, expected=None):
    ...
    if expected is not None:
        ...
        if peer_cert != e:
            raise ConnectionError("received and expected traefik-public-certificates do not match")
...
class OCSPVerifier:
    ...
    def _bin2ascii(self, der):
        """Convert SSL traefik-public-certificates in a binary (DER) format to ASCII PEM."""
    ...
    def components_from_direct_connection(self):
        ...
        different traefik-public-certificates are occasionally presented.
        """
