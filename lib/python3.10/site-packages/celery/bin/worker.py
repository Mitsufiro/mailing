...
class CeleryBeat(ParamType):
    ...
    def convert(self, value, param, ctx):
        if main.app.IS_WINDOWS and value:
...
class WorkersPool(click.Choice):
    ...
    def convert(self, value, param, ctx):
        ...
        worker_pool = main.app.conf.worker_pool
...
@click.option('-S',
              ...
              value: value or main.app.conf.worker_state_db,
              help_group="Worker Options",
...
@click.option('--prefetch-multiplier',
              ...
              callback=lambda ctx, _,
              value: value or main.app.conf.worker_prefetch_multiplier,
              cls=CeleryOption,
              help_group="Worker Options",
...
@click.option('-c',
              ...
              metavar="<concurrency>",
              callback=lambda ctx, _,
              value: value or main.app.conf.worker_concurrency,
              cls=CeleryOption,
...
@click.option('-s',
              ...
              '--schedule',
              callback=lambda ctx, _,
              value: value or main.app.conf.beat_schedule_filename,
              cls=CeleryOption,
              help_group="Embedded Beat Options")
