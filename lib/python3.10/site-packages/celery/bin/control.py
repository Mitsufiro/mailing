...
def status(ctx, timeout, destination, json, **kwargs):
    ...
    replies = main.app.control.inspect(timeout=timeout,
...
def inspect(ctx, action, timeout, destination, json, **kwargs):
    ...
    inspect = main.app.control.inspect(timeout=timeout,
                                       destination=destination,
                                       callback=callback)
...
def control(ctx, action, timeout, destination, json):
    ...
    replies = main.app.control.broadcast(action, timeout=timeout,
                                         destination=destination,
                                         callback=callback,
                                         reply=True,
                                         arguments=arguments)
