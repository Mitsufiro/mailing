...
class Hub(bootsteps.StartStopStep):
    ...
    def _patch_thread_primitives(self, w):
        ...
        main.app.clock.mutex = DummyLock()
...
class Pool(bootsteps.StartStopStep):
    ...
    def create(self, w):
        semaphore = None
        max_restarts = None
        if main.app.conf.worker_pool in GREEN_POOLS:  # pragma: no cover
...
class Beat(bootsteps.StartStopStep):
    ...
    def create(self, w):
        ...
        b = w.beat = EmbeddedService(main.app,
...
class StateDB(bootsteps.Step):
    ...
    def create(self, w):
        w._persistence = w.state.Persistent(w.state, w.statedb, main.app.clock)
