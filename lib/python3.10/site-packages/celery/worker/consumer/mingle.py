...
class Mingle(bootsteps.StartStopStep):
    ...
    def __init__(self, c, without_mingle=False, **kwargs):
        self.enabled = not without_mingle and self.compatible_transport(main.app)
        super().__init__(
    ...
    def send_hello(self, c):
        inspect = main.app.control.inspect(timeout=1.0, connection=c.connection)
    ...
    def on_clock_event(self, c, clock):
        main.app.clock.adjust(clock) if clock else main.app.clock.forward()
