...
class Gossip(bootsteps.ConsumerStep):
    ...
    def __init__(self, c, without_gossip=False,
        ...
        self.enabled = not without_gossip and self.compatible_transport(main.app)
        self.app = main.app
        c.gossip = self
        self.Receiver = main.app.events.Receiver
        ...
        self.timer = c.timer
        if self.enabled:
            self.state = main.app.events.State(
